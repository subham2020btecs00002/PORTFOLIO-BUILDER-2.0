...
export const DarkPro: React.FC<TemplateProps> = ({
  ...
  return (
    <div className="theme-container dark-pro-theme">
      {/* Glow Spheres */}
      ...
      <div className="theme-content-wrapper">
        ...
        {portfolio.pdf && (
          <section className="theme-section" style={{ textAlign: 'center' }}>
            <a href={`${baseUrl}/api/portfolio/download/${portfolio._id}`} target="_blank" rel="noopener noreferrer" className="btn-primary">
